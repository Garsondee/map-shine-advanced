...
**V2 class:** `VisionModeEffectV2` · **Source:** `legacy/compositor-v2/effects/VisionModeEffectV2.js`

**Rebuilt in V3 as:** `light.accumulate (SUPERSEDED — stays with Foundry, not MSA-rendered)`
