...
function buildCss() {
  return [
    ...
    '.map-shine-styled-loading-overlay__spinner { border-radius:50%; border:4px solid rgba(255,255,255,0.2); border-top-color: var(--ms-ls-accent, rgba(0,200,255,0.85)); }',
    '.map-shine-styled-loading-overlay__stage-row { display:flex; flex-wrap:wrap; gap:6px; row-gap:6px; justify-content:center; align-items:center; }',
    '.map-shine-styled-loading-overlay__stage-pill { display:inline-block; padding:4px 10px; border-radius:10px; font-size:11px; line-height:1.2; font-weight:700; letter-spacing:0.1px; transition: background 0.2s ease, color 0.2s ease, box-shadow 0.2s ease; }',
