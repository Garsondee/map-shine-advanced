...
export class CandleFlamesEffectV2 {
  constructor() {
    ...
    this.params = {
      ...
      dayIntensityScale: 0.53,
      nightIntensityScale: 1.6,
      dayNightCurve: 1.15,
