...
export class DustEffectV2 {
  ...
  constructor(renderBus) {
    ...
    this.params = {
      ...
      zMax: 85.0,
      motionDrift: 1.5,
      motionCurlStrength: 27.0,
      motionCurlScale: 1770.0,
  ...
  static getControlSchema() {
    return {
      ...
      groups: [
        ...
        { name: 'lifetime', label: 'Lifetime & Size', type: 'inline', advanced: true, separator: true, parameters: ['lifeMin', 'lifeMax', 'sizeMin', 'sizeMax'] },
        { name: 'volume', label: 'Volume', type: 'inline', advanced: true, separator: true, parameters: ['zMin', 'zMax'] },
        { name: 'motion', label: 'Motion', type: 'inline', advanced: true, separator: true, parameters: ['motionDrift', 'motionCurlStrength', 'motionCurlScale'] },
      ],
      parameters: {
        ...
        maxParticles: { type: 'slider', label: 'Max Particles', min: 0, max: 20000, step: 100, default: 4000, advanced: true },
        ...
        skyTintEnabled: { type: 'boolean', label: 'Sky Tint Dust', default: false, advanced: true },
        skyTintStrength: { type: 'slider', label: 'Sky Tint Strength', min: 0.0, max: 1.0, step: 0.01, default: 0.0, advanced: true },
