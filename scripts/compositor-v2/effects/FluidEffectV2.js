  ...
  static getControlSchema() {
    return {
      ...
      groups: [
        ...
        { name: 'detail', label: 'Noise & Bubbles', type: 'folder', advanced: true, expanded: false, parameters: ['noiseScale', 'noiseStrength', 'bubbleScale', 'bubbleStrength'] },
        { name: 'edges', label: 'Edge Effects', type: 'folder', advanced: true, expanded: false, parameters: ['edgeNoiseScale', 'edgeNoiseAmp', 'meniscusStrength'] },
        { name: 'foam', label: 'Foam', type: 'folder', advanced: true, expanded: false, parameters: ['foamStrength', 'foamScale', 'foamWidth', 'foamTint', 'foamTrailStrength', 'edgeFoamStrength', 'foamDensity', 'foamFrothiness'] },
        { name: 'surface', label: 'Surface Effects', type: 'folder', advanced: true, expanded: false, parameters: ['causticEnabled', 'causticStrength', 'causticScale', 'rgbShift'] },
        { name: 'iridescence', label: 'Iridescence', type: 'folder', advanced: true, expanded: false, parameters: ['iridescenceStrength', 'iriSpeed', 'iriScale', 'iriFresnel', 'iriBreakup', 'iriFlowAdvect', 'iriSpectralSpread', 'iriThicknessContrast', 'iriSwirlScale', 'iriSwirlSpeed', 'iriDetailScale', 'iriDetailWeight', 'iriSaturation'] },
        { name: 'churn', label: 'Churn & Distortion', type: 'folder', advanced: true, expanded: false, parameters: ['churnEnabled', 'churnStrength', 'churnScale', 'churnSpeed', 'churnOctaves', 'churnFlowBias'] },
        { name: 'hdrBoost', label: 'HDR / Bloom Boost', type: 'folder', advanced: true, expanded: false, parameters: ['hdrBoostEnabled', 'hdrBoostStrength', 'hdrBoostPulseSpeed', 'hdrBoostEdge', 'hdrBoostCenter'] },
        { name: 'pools', label: 'Endpoint Pools', type: 'folder', advanced: true, expanded: false, parameters: ['poolStart', 'poolEnd', 'poolSoftness'] },
        { name: 'roof', label: 'Roof Occlusion', type: 'folder', advanced: true, expanded: false, parameters: ['roofOcclusionEnabled', 'roofAlphaThreshold'] }
      ],
      parameters: {
        ...
        ageGamma:           { type: 'slider', label: 'Age Gamma',          min: 0.1, max: 4,    step: 0.01, default: 1.0, advanced: true },
