...
export class LensEffectV2 {
  constructor() {
    ...
    this.params = {
      ...
      lightBurnThresholdSoftness: 0.12,
      lightBurnPersistenceSeconds: 2.5,
      ...
      chromaticAmountPx:  1.5,
      chromaticEdgePower: 1.4,
      vignetteIntensity:  0.20,
      vignetteSoftness:   0.65,
      grainAmount:        0.030,
      grainSpeed:         1.0,
      adaptiveGrainEnabled: true,
      grainLowLightBoost: 0.85,
      grainCellSizeBright: 1.0,
      grainCellSizeDark: 2.8,
      digitalNoiseEnabled: false,
      digitalNoiseAmount: 0.015,
      digitalNoiseChance: 0.025,
      digitalNoiseGreenBias: 0.75,
      digitalNoiseLowLightBoost: 1.2,
    };
  }
  ...
  static getControlSchema() {
    ...
    return {
      ...
      parameters: {
        ...
        lightBurnThresholdSoftness: { type: 'slider', min: 0.001, max: 0.5, step: 0.005, default: 0.12, label: 'Threshold Softness' },
        lightBurnPersistenceSeconds: { type: 'slider', min: 0.05, max: 8.0, step: 0.05, default: 2.5, label: 'Persistence (s)' },
        ...
        viewfinderIntensity: { type: 'slider', min: 0.0, max: 2.0, step: 0.01, default: 0.90 },
        viewfinderLumaReactivity: { type: 'slider', min: 0.0, max: 1.0, step: 0.01, default: 0.10 },
        viewfinderLumaBoost: { type: 'slider', min: 0.5, max: 4.0, step: 0.05, default: 1.10 },
        ...
        structuralClearRadius: { type: 'slider', min: 0.0, max: 0.5, step: 0.01, default: 0.00 },
        ...
        structuralPulseMag: { type: 'slider', min: 0.0, max: 0.3, step: 0.01, default: 0.05 },
        ...
        opticalClearRadius: { type: 'slider', min: 0.0, max: 0.5, step: 0.01, default: 0.20 },
        opticalClearSoftness: { type: 'slider', min: 0.01, max: 0.3, step: 0.01, default: 0.12 },
        opticalDriftX: { type: 'slider', min: -0.001, max: 0.001, step: 0.00001, default: 0.00008 },
        opticalDriftY: { type: 'slider', min: -0.001, max: 0.001, step: 0.00001, default: 0.00005 },
        opticalPulseMag: { type: 'slider', min: 0.0, max: 0.3, step: 0.01, default: 0.07 },
        ...
        distortionAmount:   { type: 'slider', min: -0.5, max: 0.5,  step: 0.001, default: -0.08 },
        ...
        chromaticAmountPx:  { type: 'slider', min:  0.0, max: 8.0,  step: 0.01,  default:  1.5  },
        chromaticEdgePower: { type: 'slider', min:  0.1, max: 4.0,  step: 0.01,  default:  1.4  },
        vignetteIntensity:  { type: 'slider', min:  0.0, max: 1.0,  step: 0.01,  default:  0.20 },
        vignetteSoftness:   { type: 'slider', min: 0.05, max: 1.0,  step: 0.01,  default:  0.65 },
        grainAmount:        { type: 'slider', min:  0.0, max: 0.25, step: 0.001, default:  0.030 },
        ...
        grainLowLightBoost: { type: 'slider', min: 0.0, max: 3.0, step: 0.01, default: 0.85, label: 'Low-Light Grain Boost' },
        grainCellSizeBright: { type: 'slider', min: 1.0, max: 4.0, step: 0.1, default: 1.0, label: 'Grain Cell Size Bright' },
        grainCellSizeDark: { type: 'slider', min: 1.0, max: 8.0, step: 0.1, default: 2.8, label: 'Grain Cell Size Dark' },
        digitalNoiseEnabled: { type: 'boolean', default: false, label: 'Enable Digital Chroma Noise' },
        digitalNoiseAmount: { type: 'slider', min: 0.0, max: 0.15, step: 0.001, default: 0.015, label: 'Digital Noise Amount' },
        digitalNoiseChance: { type: 'slider', min: 0.0, max: 0.5, step: 0.001, default: 0.025, label: 'Digital Noise Chance' },
        digitalNoiseGreenBias: { type: 'slider', min: 0.0, max: 1.0, step: 0.01, default: 0.75, label: 'Digital Noise Green Bias' },
        digitalNoiseLowLightBoost: { type: 'slider', min: 0.0, max: 4.0, step: 0.01, default: 1.2, label: 'Digital Noise Low-Light Boost' },
      }
    };
  }
