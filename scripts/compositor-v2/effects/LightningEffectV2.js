  ...
  static getControlSchema() {
    return {
      ...
      parameters: {
        ...
        outsideFlashGain: { type: 'slider', min: 0, max: 5, step: 0.01, default: 1.09, label: 'Flash Gain' },
        ...
        minDelayMs: { type: 'slider', min: 0, max: 5000, step: 50, default: 5000, label: 'Min Delay (ms)' },
        ...
        strikeDurationMs: { type: 'slider', min: 20, max: 2400, step: 10, default: 1000, label: 'Strike Duration (ms)' },
        leaderFraction: { type: 'slider', min: 0.1, max: 0.35, step: 0.01, default: 0.15, label: 'Leader Phase', tooltip: 'Fraction of strike duration spent searching downward before the return stroke connects.' },
        flickerChance: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.15, label: 'Flicker Chance' },

        outerColor: { type: 'color', default: { r: 0, g: 0.21440094753601224, b: 1 }, label: 'Outer Color' },
        coreColor: { type: 'color', default: { r: 1, g: 1, b: 1 }, label: 'Core Color' },
        brightness: { type: 'slider', min: 0, max: 10, step: 0.05, default: 5, label: 'Brightness' },
        width: { type: 'slider', min: 1, max: 120, step: 1, default: 30, label: 'Width (px-ish)' },
        taper: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.08, label: 'Taper' },
        ...
        textureScrollSpeed: { type: 'slider', min: 0, max: 30, step: 0.1, default: 25, label: 'Texture Scroll Speed' },
        coreStaticAmount: { type: 'slider', min: 0, max: 2, step: 0.01, default: 1, label: 'Core Static Amount', tooltip: 'Crackling sparkle intensity on the bright core near the bolt base.' },
        ...
        curveAmount: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.57, label: 'Curve Amount' },
        macroDisplacement: { type: 'slider', min: 0, max: 400, step: 1, default: 96, label: 'Fractal Chaos', tooltip: 'Root zigzag strength relative to bolt length. Values tuned for midpoint-displacement paths.' },
        microJitter: { type: 'slider', min: 0, max: 120, step: 1, default: 3, label: 'Micro Jitter' },
        endPointRandomnessPx: { type: 'slider', min: 0, max: 400, step: 1, default: 5, label: 'Endpoint Randomness' },
        ...
        branchLengthMin: { type: 'slider', min: 0.05, max: 1, step: 0.01, default: 0.17, label: 'Branch Length Min' },
        branchLengthMax: { type: 'slider', min: 0.05, max: 1.5, step: 0.01, default: 0.52, label: 'Branch Length Max' },
