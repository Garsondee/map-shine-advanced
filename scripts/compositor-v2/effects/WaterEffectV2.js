...
export class WaterEffectV2 {
  constructor() {
    ...
    /** @type {'idle'|'found'|'missing'} UI-facing mask discovery phase (populate end state) */
    ...
    this.params = {
      ...
      distortionShoreRemapLo: 0,
      distortionShoreRemapHi: 1,
      distortionShorePow: 1,
      ...
      rainDistortionPrecipitationOverride: 0,
      rainDistortionStrengthPx: 6,
      rainDistortionScale: 8,
      rainDistortionSpeed: 1.2,
      rainIndoorDampingEnabled: true,
      rainIndoorDampingStrength: 1,

      // Wind coupling
      lockWaveTravelToWind: true,
      waveDirOffsetDeg: 0,
      waveAppearanceRotDeg: 0,
      waveTriBlendAngleDeg: 35,
      ...
      specModel: 1,
      specClamp: 0.65,
      specSunAzimuthDeg: 135,
      specSunElevationDeg: 45,
      specSunIntensity: 2.5,
      specNormalStrength: 1.2,
      specNormalScale: 0.6,
      specNormalMode: 3,
      specMicroStrength: 0.92,
      specMicroScale: 1.83,
      specAAStrength: 0,
      specWaveStepMul: 2,
      ...
      specHighlightsStrength: 6.7,
      specHighlightsPower: 69.9,
      specHighlightsClamp: 0,
      ...
      specSunElevationFalloffStart: 35,
      specSunElevationFalloffEnd: 10,
      ...
      causticsBrightnessThreshold: 0.07,
      causticsBrightnessSoftness: 1,
      causticsBrightnessGamma: 0.49,
      ...
      shoreFoamFilamentsScale: 5,
      shoreFoamFilamentsLength: 2,
      shoreFoamFilamentsWidth: 0.2,
      shoreFoamThicknessVariation: 0.62,
      shoreFoamThicknessScale: 5.5,
      shoreFoamEdgeDetail: 1,
      shoreFoamEdgeDetailScale: 24,

      // Shore Foam Distortion & Evolution
      shoreFoamWaveDistortionStrength: 1.3,
      shoreFoamNoiseDistortionEnabled: true,
      shoreFoamNoiseDistortionStrength: 1,
      ...
      floatingFoamStrength: 0.4,
      floatingFoamCoverage: 0.35,
      floatingFoamScale: 8,
      floatingFoamWaveDistortion: 3.27,

      // Floating Foam Advanced (Phase 1)
      floatingFoamColor: { r: 1, g: 1, b: 1 },
      floatingFoamOpacity: 1,
      floatingFoamBrightness: 1,
      floatingFoamContrast: 4,
      ...
      floatingFoamAmbientLight: 1,
      floatingFoamSceneLightInfluence: 1,
      ...
      floatingFoamNoiseDistortionSpeed: 5,
      floatingFoamEvolutionEnabled: true,
      floatingFoamEvolutionSpeed: 2,
      floatingFoamEvolutionAmount: 0.96,
      floatingFoamEvolutionScale: 7,
      ...
      bathymetryDepthCurve: 2,
      bathymetryMaxDepth: 2,
      bathymetryStrength: 1,
      bathymetryAbsorptionCoeff: { r: 0.01568627450980392, g: 0.0058823529411764705, b: 0.0003921568627450981 },
      bathymetryDeepScatterColor: { r: 0.02, g: 0.1, b: 0.2 },
...
static getControlSchema() {
    return {
      ...
      parameters: {
        enabled: { type: 'boolean', default: { r: 0.02, g: 0.1, b: 0.2 }, label: 'Enabled' },
        ...
        waveBreakupScale: { type: 'slider', min: 1, max: 300, step: 0.1, default: 80, label: 'Breakup Scale' },
        ...
        waveBreakupDistortionStrength: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.1, label: 'Breakup Distortion' },
        ...
        waveMicroNormalScale: { type: 'slider', min: 1, max: 300, step: 0.1, default: 80, label: 'Micro Normal Scale' },
        ...
        rainDistortionScale: { type: 'slider', min: 0.5, max: 40, step: 0.1, default: 8, label: 'Distortion Scale' },
        ...
        specRoughnessMax: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.3, label: 'Roughness Max' },
        specSurfaceChaos: {
        ...
        specSkyTint: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.71, label: 'Sky Tint' },
        skyIntensity: { type: 'slider', min: 0, max: 1, step: 0.01, default: 1, label: 'Sky Intensity' },
        ...
        specAnisotropy: { type: 'slider', min: -1, max: 1, step: 0.01, default: 0, label: 'Anisotropy' },
        specAnisoRatio: { type: 'slider', min: 0.1, max: 8, step: 0.01, default: 2, label: 'Aniso Ratio' },

        specHighlightsEnabled: { type: 'boolean', default: true, label: 'Enabled' },
        specHighlightsStrength: { type: 'slider', min: 0, max: 2000, step: 0.1, default: 6.7, label: 'Strength' },
        specHighlightsPower: { type: 'slider', min: 0.1, max: 256, step: 0.1, default: 69.9, label: 'Power (Sharpness)' },
        specHighlightsClamp: { type: 'slider', min: 0, max: 4, step: 0.01, default: 0, label: 'Clamp' },
        ...
        specSunElevationFalloffStart: { type: 'slider', min: 0, max: 90, step: 0.5, default: 35, label: 'Falloff Start (deg)' },
        ...
        cloudShadowSpecularCurve: { type: 'slider', min: 0.1, max: 12, step: 0.01, default: 6, label: 'Specular Curve' },
        ...
        shoreFoamSpeed: { type: 'slider', min: 0, max: 2, step: 0.01, default: 0.09, label: 'Speed' },
        shoreFoamCoverage: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.52, label: 'Coverage' },
        ...
        shoreFoamColor: { type: 'color', default: { r: 1, g: 1, b: 1 }, label: 'Color' },
        ...
        shoreFoamColorVariation: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.77, label: 'Variation' },
        shoreFoamOpacity: { type: 'slider', min: 0, max: 1, step: 0.01, default: 1, label: 'Opacity' },
        shoreFoamBrightness: { type: 'slider', min: 0, max: 1.5, step: 0.01, default: 0.6, label: 'Brightness' },
        shoreFoamContrast: { type: 'slider', min: 0, max: 4, step: 0.01, default: 2.74, label: 'Contrast' },
        ...
        shoreFoamAmbientLight: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.5, label: 'Ambient' },
        ...
        shoreFoamFilamentsScale: { type: 'slider', min: 0.1, max: 20, step: 0.1, default: 5, label: 'Filaments Scale' },
        shoreFoamFilamentsLength: { type: 'slider', min: 0.1, max: 10, step: 0.1, default: 2, label: 'Filaments Length' },
        shoreFoamFilamentsWidth: { type: 'slider', min: 0.01, max: 1, step: 0.01, default: 0.2, label: 'Filaments Width' },
        shoreFoamThicknessVariation: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.62, label: 'Thickness Var' },
        shoreFoamThicknessScale: { type: 'slider', min: 0.1, max: 20, step: 0.1, default: 5.5, label: 'Thickness Scale' },
        shoreFoamEdgeDetail: { type: 'slider', min: 0, max: 1, step: 0.01, default: 1, label: 'Edge Detail' },
        shoreFoamEdgeDetailScale: { type: 'slider', min: 0.1, max: 40, step: 0.1, default: 24, label: 'Edge Scale' },
        shoreFoamWaveDistortionStrength: { type: 'slider', min: 0, max: 10, step: 0.1, default: 1.3, label: 'Wave Distortion' },
        ...
        floatingFoamStrength: { type: 'slider', min: 0, max: 2, step: 0.01, default: 0.4, label: 'Strength' },
        floatingFoamCoverage: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.35, label: 'Coverage' },
        floatingFoamScale: { type: 'slider', min: 1, max: 500, step: 1.0, default: 8, label: 'Scale' },
        floatingFoamWaveDistortion: { type: 'slider', min: 0, max: 10, step: 0.01, default: 3.27, label: 'Wave Distortion' },
        ...
        floatingFoamGamma: { type: 'slider', min: 0.1, max: 10, step: 0.01, default: 0.1, label: 'Gamma' },
        ...
        murkCloudGamma: { type: 'slider', min: 0.1, max: 4, step: 0.01, default: 1, label: 'Cloud Gamma' },
  ...
  async populate(foundrySceneData) {
    ...
    this._maskDiscoveryPhase = this._hasAnyWaterData ? 'found' : 'missing';
    this._notifyMaskStatusUi();
  ...
  /** Push latest _Water mask discovery state into the Water Tweakpane row. */
  _notifyMaskStatusUi() {
    refreshEffectMaskStatusUi('water');
  }
  ...
  update(timeInfo) {
    ...
    // ── Distortion edge ───────────────────────────────────────────────────
    u.uDistortionEdgeCenter.value = safeNum(p.distortionEdgeCenter, 0.5);
    u.uDistortionEdgeFeather.value = safeNum(p.distortionEdgeFeather, 0.06);
