  ...
  static getControlSchema() {
    return {
      ...
      parameters: {
        ...
        foamPeakOpacity: { type: 'slider', label: 'Peak Opacity', min: 0, max: 1, step: 0.01, default: 1.0 },
        foamLifeMin: { type: 'slider', label: 'Life Min', min: 0.05, max: 20, step: 0.05, default: 0.50 },
        foamLifeMax: { type: 'slider', label: 'Life Max', min: 0.05, max: 20, step: 0.05, default: 0.70 },
        foamSizeMin: { type: 'slider', label: 'Size Min', min: 1, max: 1000, step: 1, default: 101 },
        foamSizeMax: { type: 'slider', label: 'Size Max', min: 1, max: 1000, step: 1, default: 154 },
        foamWindDriftScale: { type: 'slider', label: 'Wind Drift', min: 0, max: 2, step: 0.01, default: 0.05 },
        foamColorR: { type: 'slider', label: 'Color R', min: 0, max: 2, step: 0.01, default: 0.85 },
        foamColorG: { type: 'slider', label: 'Color G', min: 0, max: 2, step: 0.01, default: 1.22 },
  ...
  static getBubblesControlSchema() {
    return {
      ...
      parameters: {
        ...
        foamEnabled: { type: 'boolean', label: 'Enabled', default: true },
        foamRate: { type: 'slider', label: 'Rate', min: 0, max: 200, step: 0.1, default: 25 },
        foamPeakOpacity: { type: 'slider', label: 'Peak Opacity', min: 0, max: 1, step: 0.01, default: 0.34 },
