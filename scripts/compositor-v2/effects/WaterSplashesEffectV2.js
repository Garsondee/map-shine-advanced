  ...
  static getControlSchema() {
    return {
      ...
      parameters: {
        ...
        foamLifeMin: { type: 'slider', label: 'Life Min', min: 0.05, max: 20, step: 0.05, default: 0.5, advanced: true },
        foamLifeMax: { type: 'slider', label: 'Life Max', min: 0.05, max: 20, step: 0.05, default: 1.0, advanced: true },
        foamSizeMin: { type: 'slider', label: 'Size Min', min: 1, max: 1000, step: 1, default: 102, advanced: true },
        foamSizeMax: { type: 'slider', label: 'Size Max', min: 1, max: 1000, step: 1, default: 167, advanced: true },
        foamWindDriftScale: { type: 'slider', label: 'Wind Drift', min: 0, max: 2, step: 0.01, default: 2.0, advanced: true },
        foamColorR: { type: 'slider', label: 'Color R', min: 0, max: 2, step: 0.01, default: 0.17, advanced: true },
        foamColorG: { type: 'slider', label: 'Color G', min: 0, max: 2, step: 0.01, default: 0.24, advanced: true },
        foamColorB: { type: 'slider', label: 'Color B', min: 0, max: 2, step: 0.01, default: 0.15, advanced: true },
        ...
        splashSizeMin: { type: 'slider', label: 'Size Min', min: 1, max: 1000, step: 1, default: 99, advanced: true },
        splashSizeMax: { type: 'slider', label: 'Size Max', min: 1, max: 1000, step: 1, default: 457, advanced: true },
        splashWindDriftScale: { type: 'slider', label: 'Splash Wind Drift', min: 0, max: 2, step: 0.01, default: 1.0, advanced: true },
  ...
  static getBubblesControlSchema() {
    return {
      ...
      parameters: {
        ...
        foamLifeMin: { type: 'slider', label: 'Life Min', min: 0.05, max: 20, step: 0.05, default: 1.2, advanced: true },
        foamLifeMax: { type: 'slider', label: 'Life Max', min: 0.05, max: 20, step: 0.05, default: 3.25, advanced: true },
        foamSizeMin: { type: 'slider', label: 'Size Min', min: 1, max: 1000, step: 1, default: 35, advanced: true },
        foamSizeMax: { type: 'slider', label: 'Size Max', min: 1, max: 1000, step: 1, default: 373, advanced: true },
        foamWindDriftScale: { type: 'slider', label: 'Wind Drift', min: 0, max: 2, step: 0.01, default: 2.0, advanced: true },
        foamColorR: { type: 'slider', label: 'Color R', min: 0, max: 2, step: 0.01, default: 0.97, advanced: true },
        foamColorG: { type: 'slider', label: 'Color G', min: 0, max: 2, step: 0.01, default: 0.982, advanced: true },
        foamColorB: { type: 'slider', label: 'Color B', min: 0, max: 2, step: 0.01, default: 1.0, advanced: true },
