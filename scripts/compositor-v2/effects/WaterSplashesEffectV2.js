  ...
  static getBubblesControlSchema() {
    return {
      ...
      parameters: {
        ...
        foamPeakOpacity: { type: 'slider', label: 'Peak Opacity', min: 0, max: 1, step: 0.01, default: 0.1 },
        foamLifeMin: { type: 'slider', label: 'Life Min', min: 0.05, max: 20, step: 0.05, default: 3.1, advanced: true },
        foamLifeMax: { type: 'slider', label: 'Life Max', min: 0.05, max: 20, step: 0.05, default: 6.8, advanced: true },
