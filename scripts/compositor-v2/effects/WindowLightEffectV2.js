  ...
  static getControlSchema() {
    ...
    return {
      ...
      groups: [
        ...
        { name: 'sunTracking', label: 'Sun Tracking', type: 'folder', advanced: true, expanded: false, parameters: ['sunLightEnabled', 'sunLightLength'] },
        ...
        { name: 'cloudShadows', label: 'Cloud Shadows', type: 'folder', advanced: true, expanded: false, parameters: ['cloudShadowContrast', 'cloudShadowBias', 'cloudShadowGamma', 'cloudShadowMinLight'] },
        { name: 'refraction', label: 'Refraction (RGB)', type: 'folder', advanced: true, expanded: false, parameters: ['rgbShiftAmount', 'rgbShiftAngle'] },
        { name: 'overheads', label: 'Overhead Tile Lighting', type: 'folder', advanced: true, expanded: false, parameters: ['lightOverheadTiles', 'overheadLightIntensity'] },
        { name: 'specular', label: 'Specular Coupling', type: 'folder', advanced: true, expanded: false, parameters: ['specularBoost'] },
        { name: 'rainCore', label: 'Rain On Glass (Core)', type: 'folder', advanced: true, expanded: true, parameters: ['rainOnGlassEnabled', 'rainOnGlassIntensity', 'rainOnGlassPrecipStart', 'rainOnGlassPrecipFull', 'rainOnGlassSpeed', 'rainOnGlassDirectionDeg'] },
        { name: 'rainNoise', label: 'Rain On Glass (Noise & Rivulets)', type: 'folder', advanced: true, expanded: true, parameters: ['rainNoiseScale', 'rainNoiseDetail', 'rainNoiseEvolution', 'rainRivuletAspect', 'rainRivuletGain', 'rainRivuletStrength', 'rainRivuletThreshold', 'rainRivuletFeather', 'rainRivuletGamma', 'rainRivuletSoftness', 'rainRivuletRidgeMix', 'rainRivuletRidgeGain'] },
        { name: 'rainDistortion', label: 'Rain On Glass (Distortion & Darken)', type: 'folder', advanced: true, expanded: false, parameters: ['rainOnGlassMaxOffsetPx', 'rainOnGlassBlurPx', 'rainOnGlassDistortionFeatherPx', 'rainOnGlassDistortionMasking', 'rainOnGlassDarken', 'rainOnGlassDarkenGamma', 'rainOnGlassBrightThreshold', 'rainOnGlassBrightFeather'] },
        { name: 'rainBoundaryFlow', label: 'Rain On Glass (Boundary Flow)', type: 'folder', advanced: true, expanded: false, parameters: ['rainOnGlassBoundaryFlowStrength', 'rainFlowWidth', 'rainRoofPlateauStrength', 'rainRoofPlateauStart', 'rainRoofPlateauFeather', 'rainRivuletDistanceMasking', 'rainRivuletDistanceStart', 'rainRivuletDistanceEnd', 'rainRivuletDistanceFeather'] },
        { name: 'rainSplashesCore', label: 'Rain Splashes (Core)', type: 'folder', advanced: true, expanded: false, parameters: ['rainSplashIntensity', 'rainSplashSpawnRate', 'rainSplashSpeed', 'rainSplashLayers'] },
        { name: 'rainSplashesShape', label: 'Rain Splashes (Shape)', type: 'folder', advanced: true, expanded: false, parameters: ['rainSplashScale', 'rainSplashThreshold', 'rainSplashMaskScale', 'rainSplashMaskThreshold', 'rainSplashMaskFeather', 'rainSplashRadiusPx', 'rainSplashExpand', 'rainSplashFadePow', 'rainSplashMaxOffsetPx'] },
        { name: 'rainSplashesDrift', label: 'Rain Splashes (Drift & Streaks)', type: 'folder', advanced: true, expanded: false, parameters: ['rainSplashDriftPx', 'rainSplashSizeJitter', 'rainSplashBlob', 'rainSplashStreakStrength', 'rainSplashStreakLengthPx', 'rainSplashAtlasTile0', 'rainSplashAtlasTile1', 'rainSplashAtlasTile2', 'rainSplashAtlasTile3'] },
        { name: 'rainFlowDirection', label: 'Flow Map (Direction & Motion)', type: 'folder', advanced: true, expanded: false, parameters: ['rainFlowFlipDeadzone', 'rainFlowMaxTurnDeg', 'rainFlowInvertTangent', 'rainFlowInvertNormal', 'rainFlowSwapAxes', 'rainFlowAdvectScale', 'rainFlowEvoScale', 'rainFlowPerpScale', 'rainFlowGlobalInfluence', 'rainFlowAngleOffset'] },
        { name: 'rainFlowMapGen', label: 'Flow Map (Generation)', type: 'folder', advanced: true, expanded: false, parameters: ['rebuildRainFlowMap', 'rainFlowMapMaxDim', 'rainFlowMapMinDim', 'rainFlowMapObstacleThreshold', 'rainFlowMapObstacleInvert', 'rainFlowMapBoundaryMaxPx', 'rainFlowMapDistanceGamma', 'rainFlowMapDistanceScale', 'rainFlowMapRelaxIterations', 'rainFlowMapRelaxKernel', 'rainFlowMapRelaxMix', 'rainFlowMapDefaultX', 'rainFlowMapDefaultY'] },
        { name: 'rainDebug', label: 'Rain Debug', type: 'folder', advanced: true, expanded: false, parameters: ['rainDebugRoofPlateau', 'rainDebugFlowMap'] },
        { name: 'lightning', label: 'Lightning Flash (Window)', type: 'folder', advanced: true, expanded: false, parameters: ['lightningWindowEnabled', 'lightningWindowIntensityBoost', 'lightningWindowContrastBoost', 'lightningWindowRgbBoost'] }
      ],
      parameters: {
