...
export class HalftoneEffect extends EffectBase {
  ...
  initialize(renderer, scene, camera) {
    ...
    this.material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        scatter: { value: this.params.scatter },
        width: { value: 1.0 },
        height: { value: 1.0 },
        blending: { value: this.params.strength },
        blendingMode: { value: this.params.blendingMode },
  ...
  update(timeInfo) {
    ...
    u.shape.value = p.shape;
    u.scatter.value = p.scatter;
    u.blending.value = p.strength;
    u.blendingMode.value = p.blendingMode;
