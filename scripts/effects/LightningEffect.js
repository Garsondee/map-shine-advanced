  ...
  static getControlSchema() {
    return {
      ...
      parameters: {
        ...
        minDelayMs: { type: 'slider', min: 0, max: 5000, step: 50, default: 600, label: 'Min Delay (ms)' },
        maxDelayMs: { type: 'slider', min: 0, max: 10000, step: 50, default: 2400, label: 'Max Delay (ms)' },

        burstMinStrikes: { type: 'slider', min: 1, max: 10, step: 1, default: 1, label: 'Burst Min Strikes' },
        burstMaxStrikes: { type: 'slider', min: 1, max: 16, step: 1, default: 3, label: 'Burst Max Strikes' },
        strikeDurationMs: { type: 'slider', min: 20, max: 800, step: 10, default: 120, label: 'Strike Duration (ms)' },
        strikeDelayMs: { type: 'slider', min: 0, max: 500, step: 5, default: 60, label: 'Strike Spacing (ms)' },
        ...
        brightness: { type: 'slider', min: 0, max: 10, step: 0.05, default: 2.2, label: 'Brightness' },
        ...
        curveAmount: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.35, label: 'Curve Amount' },
        macroDisplacement: { type: 'slider', min: 0, max: 400, step: 1, default: 95, label: 'Macro Displacement' },
        microJitter: { type: 'slider', min: 0, max: 120, step: 1, default: 18, label: 'Micro Jitter' },
        endPointRandomnessPx: { type: 'slider', min: 0, max: 400, step: 1, default: 0, label: 'Endpoint Randomness' },

        branchChance: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.35, label: 'Branch Chance' },
        branchMax: { type: 'slider', min: 0, max: 6, step: 1, default: 2, label: 'Branch Max' },
        branchLengthMin: { type: 'slider', min: 0.05, max: 1, step: 0.01, default: 0.18, label: 'Branch Length Min' },
        branchLengthMax: { type: 'slider', min: 0.05, max: 1.5, step: 0.01, default: 0.5, label: 'Branch Length Max' },
        branchWidthScale: { type: 'slider', min: 0.05, max: 1, step: 0.01, default: 0.55, label: 'Branch Width Scale' },
        branchIntensityScale: { type: 'slider', min: 0.05, max: 1, step: 0.01, default: 0.6, label: 'Branch Intensity Scale' },
        branchDurationScale: { type: 'slider', min: 0.1, max: 1, step: 0.01, default: 0.7, label: 'Branch Duration Scale' },
        branchForwardBias: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.35, label: 'Branch Forward Bias' },
        branchPerpBias: { type: 'slider', min: 0, max: 2, step: 0.01, default: 0.95, label: 'Branch Perp Bias' },

        wildArcChance: { type: 'slider', min: 0, max: 1, step: 0.01, default: 0.1, label: 'Wild Arc Chance' },
