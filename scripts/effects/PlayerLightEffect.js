...
export class PlayerLightEffect extends EffectBase {
  constructor() {
    ...
    this.params = {
      ...
      flashlightBeamWidthScale: 1.0,
      flashlightBeamNearWidth: 0.12,
      ...
      flashlightCookieIntensity: 1.0,
      flashlightCookieSizePx: 120,
      flashlightCookieSizeFromBeam: 0.75,
      ...
      flashlightCookiePerspectiveNearScale: 0.70,
      flashlightCookiePerspectiveFarScale: 1.55,
      flashlightCookiePerspectiveCurve: 1.35,
      flashlightCookiePerspectiveAnamorphic: 1.65,

      torchLightEnabled: true,
      torchLightColor: { r: 1.0, g: 0.42, b: 0.12 },
      torchLightDim: 10,
      torchLightBright: 3,
      torchLightAlpha: 0.65,
      torchLightAttenuation: 0.55,
      torchLightLuminosity: 0.55,
      torchLightAnimType: 'torch',
      torchLightAnimSpeed: 6,
      torchLightAnimIntensity: 8,
      torchLightScaleWithIntensity: true,

      torchFlameSizeMin: 24,
      torchFlameSizeMax: 44,
      ...
      flashlightLightColor: { r: 1.0, g: 0.98, b: 0.9 },
      flashlightLightDim: 14,
      flashlightLightBright: 6,
      flashlightLightAlpha: 0.55,
      flashlightLightAttenuation: 0.35,
      flashlightLightLuminosity: 0.35,
      flashlightLightAnimType: 'none',
      flashlightLightAnimSpeed: 5,
      flashlightLightAnimIntensity: 2,
      flashlightLightUseCookiePosition: true,
      flashlightLightDistanceScaleEnabled: true,
      flashlightLightDistanceScaleNear: 0.55,
      flashlightLightDistanceScaleFar: 1.45,
  ...
  static getControlSchema() {
    return {
      ...
      parameters: {
        ...
        flickerSpeed: { type: 'slider', label: 'Flicker Speed', min: 0.1, max: 40, step: 0.1, default: 6, throttle: 50 },
        wanderPixels: { type: 'slider', label: 'Wander (px)', min: 0, max: 140, step: 1, default: 18, throttle: 50 },
        ...
        flashlightIntensity: { type: 'slider', label: 'Intensity', min: 0, max: 6, step: 0.01, default: 0.9, throttle: 50 },
        ...
        flashlightBeamWidthScale: { type: 'slider', label: 'Width Scale', min: 0.05, max: 3.0, step: 0.01, default: 1.0, throttle: 50 },
        flashlightBeamNearWidth: { type: 'slider', label: 'Near Width', min: 0.01, max: 1.5, step: 0.01, default: 0.12, throttle: 50 },
        ...
        flashlightCookieIntensity: { type: 'slider', label: 'Intensity Mult', min: 0.0, max: 6.0, step: 0.01, default: 1.0, throttle: 50 },
        flashlightCookieSizePx: { type: 'slider', label: 'Size (px)', min: 1, max: 600, step: 1, default: 120, throttle: 50 },
        flashlightCookieSizeFromBeam: { type: 'slider', label: 'Size From Beam', min: 0.0, max: 3.0, step: 0.01, default: 0.75, throttle: 50 },
        ...
        flashlightCookiePerspectiveNearScale: { type: 'slider', label: 'Perspective Near', min: 0.1, max: 2.0, step: 0.01, default: 0.70, throttle: 50 },
        flashlightCookiePerspectiveFarScale: { type: 'slider', label: 'Perspective Far', min: 0.1, max: 4.0, step: 0.01, default: 1.55, throttle: 50 },
        flashlightCookiePerspectiveCurve: { type: 'slider', label: 'Perspective Curve', min: 0.1, max: 4.0, step: 0.01, default: 1.35, throttle: 50 },
        flashlightCookiePerspectiveAnamorphic: { type: 'slider', label: 'Perspective Stretch', min: 0.1, max: 6.0, step: 0.01, default: 1.65, throttle: 50 },
        ...
        torchLightDim: { type: 'slider', label: 'Dim Radius (u)', min: 0, max: 160, step: 0.5, default: 10, throttle: 50 },
        torchLightBright: { type: 'slider', label: 'Bright Radius (u)', min: 0, max: 120, step: 0.5, default: 3, throttle: 50 },
        torchLightAlpha: { type: 'slider', label: 'Alpha', min: 0, max: 2, step: 0.01, default: 0.65, throttle: 50 },
        torchLightAttenuation: { type: 'slider', label: 'Attenuation', min: 0, max: 1, step: 0.01, default: 0.55, throttle: 50 },
        torchLightLuminosity: { type: 'slider', label: 'Luminosity', min: 0, max: 3, step: 0.01, default: 0.55, throttle: 50 },
        torchLightAnimType: {
          type: 'list',
          label: 'Animation',
        ...
        torchLightAnimSpeed: { type: 'slider', label: 'Anim Speed', min: 0.0, max: 40, step: 0.1, default: 6, throttle: 50 },
        torchLightAnimIntensity: { type: 'slider', label: 'Anim Intensity', min: 0, max: 25, step: 0.1, default: 8, throttle: 50 },
        torchLightScaleWithIntensity: { type: 'boolean', label: 'Scale With Torch', default: true },

        torchFlameSizeMin: { type: 'slider', label: 'Size Min (px)', min: 1, max: 120, step: 1, default: 24, throttle: 50 },
        torchFlameSizeMax: { type: 'slider', label: 'Size Max (px)', min: 1, max: 180, step: 1, default: 44, throttle: 50 },
        ...
        flashlightLightColor: { type: 'color', label: 'Color', default: { r: 1.0, g: 0.98, b: 0.9 } },
        flashlightLightDim: { type: 'slider', label: 'Dim Radius (u)', min: 0, max: 240, step: 0.5, default: 14, throttle: 50 },
        flashlightLightBright: { type: 'slider', label: 'Bright Radius (u)', min: 0, max: 200, step: 0.5, default: 6, throttle: 50 },
        flashlightLightAlpha: { type: 'slider', label: 'Alpha', min: 0, max: 2, step: 0.01, default: 0.55, throttle: 50 },
        flashlightLightAttenuation: { type: 'slider', label: 'Attenuation', min: 0, max: 1, step: 0.01, default: 0.35, throttle: 50 },
        flashlightLightLuminosity: { type: 'slider', label: 'Luminosity', min: 0, max: 3, step: 0.01, default: 0.35, throttle: 50 },
        flashlightLightAnimType: {
          type: 'list',
          label: 'Animation',
        ...
        flashlightLightAnimIntensity: { type: 'slider', label: 'Anim Intensity', min: 0, max: 25, step: 0.1, default: 2, throttle: 50 },
        ...
        flashlightLightDistanceScaleNear: { type: 'slider', label: 'Near Scale', min: 0.1, max: 3, step: 0.01, default: 0.55, throttle: 50 },
        flashlightLightDistanceScaleFar: { type: 'slider', label: 'Far Scale', min: 0.1, max: 3, step: 0.01, default: 1.45, throttle: 50 },
