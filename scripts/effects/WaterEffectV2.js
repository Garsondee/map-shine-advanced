  ...
  static getControlSchema() {
    return {
      ...
      groups: [
        ...
        },
        {
          ...
          parameters: [
            ...
            'sandWindDriftScale',
            'sandLayeringEnabled',
            'sandLayerScaleSpread',
            'sandLayerIntensitySpread',
            'sandLayerDriftSpread',
            'sandLayerEvolutionSpread',
            'sandBillowStrength',
            'sandCoverage',
            'sandChunkSoftness',
            'sandSpeckCoverage',
      ...
      parameters: {
        ...
        sandChunkScale: { type: 'slider', label: 'Sand Chunk Scale', min: 1.0, max: 60.0, step: 0.1, default: 12.0 },
        sandChunkSpeed: { type: 'slider', label: 'Sand Chunk Evolution', min: 0.0, max: 3.0, step: 0.01, default: 0.3 },
        sandGrainScale: { type: 'slider', label: 'Sand Grain Scale', min: 50.0, max: 12000.0, step: 1.0, default: 600.0 },
        sandGrainSpeed: { type: 'slider', label: 'Sand Grain Evolution', min: 0.0, max: 5.0, step: 0.01, default: 1.81 },
        sandWindDriftScale: { type: 'slider', label: 'Sand Wind Drift Scale', min: 0.0, max: 3.0, step: 0.01, default: 0.5 },

        sandLayeringEnabled: { type: 'boolean', label: 'Sand Layering (3-Layer)', default: false },
        sandLayerScaleSpread: { type: 'slider', label: 'Layer Scale Spread', min: 0.0, max: 1.0, step: 0.01, default: 0.5 },
        sandLayerIntensitySpread: { type: 'slider', label: 'Layer Intensity Spread', min: 0.0, max: 1.0, step: 0.01, default: 0.65 },
        sandLayerDriftSpread: { type: 'slider', label: 'Layer Drift Spread', min: 0.0, max: 1.0, step: 0.01, default: 0.4 },
        sandLayerEvolutionSpread: { type: 'slider', label: 'Layer Evolution Spread', min: 0.0, max: 1.0, step: 0.01, default: 0.5 },
