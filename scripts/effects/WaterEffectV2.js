...
export class WaterEffectV2 extends EffectBase {
  constructor() {
    ...
    this.params = {
      ...
      waveWarpLargeStrength: 0.33,
      waveWarpSmallStrength: 0.14,
      ...
      waveEvolutionSpeed: 0.41,
      waveEvolutionAmount: 1,
      waveEvolutionScale: 1.09,
      ...
      shoreNoiseDistortionStrengthPx: 0.01,
      shoreNoiseDistortionFrequency: 304.4,
      ...
      floatingFoamStrength: 0.45,
      floatingFoamCoverage: 0.2,
      floatingFoamScale: 47,
      floatingFoamWaveDistortion: 0.7,
      ...
      foamPlumeAdditiveBoost: 1.51,
      foamPlumeColor: { r: 1.0, g: 1.0, b: 1.0 },

      foamPlumeRandomOpacityMin: 1.03,
      ...
      foamParticleNoiseStrength: 1,
      foamParticleNoiseScale: 22.2,
      ...
      simpleFoamThreshold: 0.79,
      simpleFoamStride: 2,
      simpleFoamMaxPoints: 23560,
      ...
      sandEnabled: true,
      sandIntensity: 1,
      sandColor: { r: 51, g: 45.852033635195596, b: 10.960533142089842 },
      sandContrast: 0.25,
      sandChunkScale: 16.6,
      sandChunkSpeed: 3,
      sandGrainScale: 54,
      sandGrainSpeed: 5,
      sandBillowStrength: 1,

      sandCoverage: 1,
      sandChunkSoftness: 0.5,
      sandSpeckCoverage: 0.51,
      sandSpeckSoftness: 0.5,
      sandDepthLo: 0.23,
      sandDepthHi: 1,
      sandAnisotropy: 0.54,
      sandDistortionStrength: 0.37,
      sandAdditive: 0,
    ...
    this._distortionWaterParams = {
      ...
      shoreNoiseStrengthPx: 0.01,
      shoreNoiseFrequency: 304.4,
  ...
  static getControlSchema() {
    return {
      ...
      parameters: {
        ...
        tintStrength: { type: 'slider', label: 'Tint Strength', min: 0, max: 1, step: 0.01, default: 0.08 },
        ...
        cloudShadowDarkenStrength: { type: 'slider', label: 'Darken Strength', min: 0.0, max: 2.0, step: 0.01, default: 0.9 },
        ...
        maskThreshold: { type: 'slider', label: 'Mask Threshold', min: 0.0, max: 1.0, step: 0.01, default: 1, throttle: 50 },
        ...
        sdfRangePx: { type: 'slider', label: 'SDF Range (px)', min: 8, max: 256, step: 1, default: 126, throttle: 50 },
        shoreWidthPx: { type: 'slider', label: 'Shore Width (px)', min: 1, max: 128, step: 1, default: 50, throttle: 50 },

        waveScale: { type: 'slider', label: 'Wave Scale', min: 1, max: 60, step: 0.5, default: 7 },
        waveSpeed: { type: 'slider', label: 'Wave Speed', min: 0, max: 2.0, step: 0.01, default: 0.1 },
        waveStrength: { type: 'slider', label: 'Wave Strength', min: 0, max: 2.0, step: 0.01, default: 2 },

        waveWarpLargeStrength: { type: 'slider', label: 'Warp Large', min: 0.0, max: 1.0, step: 0.01, default: 0.33 },
        waveWarpSmallStrength: { type: 'slider', label: 'Warp Small', min: 0.0, max: 0.5, step: 0.01, default: 0.14 },
        waveWarpMicroStrength: { type: 'slider', label: 'Warp Micro', min: 0.0, max: 0.25, step: 0.005, default: 0.035 },
        waveWarpTimeSpeed: { type: 'slider', label: 'Warp Time Speed', min: 0.0, max: 0.25, step: 0.005, default: 0.015 },

        waveEvolutionEnabled: { type: 'boolean', label: 'Sea State Evolution', default: true },
        waveEvolutionSpeed: { type: 'slider', label: 'Evolution Speed', min: 0.0, max: 0.5, step: 0.005, default: 0.41 },
        waveEvolutionAmount: { type: 'slider', label: 'Evolution Amount', min: 0.0, max: 1.0, step: 0.01, default: 1 },
        waveEvolutionScale: { type: 'slider', label: 'Evolution Scale', min: 0.01, max: 2.0, step: 0.01, default: 1.09 },
        waveSpeedUseWind: { type: 'boolean', label: 'Wave Speed Linked To Wind', default: true },
        waveSpeedWindMinFactor: { type: 'slider', label: 'Wave Speed @ Wind=0', min: 0.0, max: 1.0, step: 0.01, default: 1 },
        ...
        distortionStrengthPx: { type: 'slider', label: 'Distortion Strength (px)', min: 0, max: 64.0, step: 0.01, default: 9.97 },

        shoreNoiseDistortionEnabled: { type: 'boolean', label: 'Shore Noise Enabled', default: true },
        shoreNoiseDistortionStrengthPx: { type: 'slider', label: 'Shore Noise Strength (px)', min: 0.0, max: 64.0, step: 0.01, default: 0.01 },
        shoreNoiseDistortionFrequency: { type: 'slider', label: 'Shore Noise Frequency', min: 0.1, max: 1200.0, step: 0.1, default: 304.4 },
        shoreNoiseDistortionSpeed: { type: 'slider', label: 'Shore Noise Speed', min: 0.0, max: 5.0, step: 0.01, default: 1.16 },
        shoreNoiseDistortionFadeLo: { type: 'slider', label: 'Shore Noise Fade Lo', min: 0.0, max: 1.0, step: 0.001, default: 0 },
        shoreNoiseDistortionFadeHi: { type: 'slider', label: 'Shore Noise Fade Hi', min: 0.0, max: 1.0, step: 0.001, default: 0.132 },

        refractionMultiTapEnabled: { type: 'boolean', label: 'Refraction Multi-Tap (Blur)', default: true },
        chromaticAberrationEnabled: { type: 'boolean', label: 'Chromatic Aberration (RGB Shift)', default: true },
        chromaticAberrationStrengthPx: { type: 'slider', label: 'RGB Shift Strength (px)', min: 0.0, max: 6.0, step: 0.01, default: 2.17 },
        chromaticAberrationEdgeCenter: { type: 'slider', label: 'RGB Edge Center', min: 0.0, max: 1.0, step: 0.001, default: 0 },
        chromaticAberrationEdgeFeather: { type: 'slider', label: 'RGB Edge Feather', min: 0.0, max: 0.2, step: 0.001, default: 0.042 },
        chromaticAberrationEdgeGamma: { type: 'slider', label: 'RGB Edge Gamma', min: 0.05, max: 4.0, step: 0.01, default: 0.05 },
        ...
        distortionEdgeCenter: { type: 'slider', label: 'Edge Center', min: 0.0, max: 1.0, step: 0.001, default: 0.406 },
        distortionEdgeFeather: { type: 'slider', label: 'Edge Feather', min: 0.0, max: 0.2, step: 0.001, default: 0.2 },
        distortionEdgeGamma: { type: 'slider', label: 'Edge Gamma', min: 0.05, max: 4.0, step: 0.01, default: 0.36 },
        ...
        distortionShorePow: { type: 'slider', label: 'Shore Curve', min: 0.05, max: 6.0, step: 0.01, default: 0.91 },
        distortionShoreMin: { type: 'slider', label: 'Shore Min', min: 0.0, max: 1.0, step: 0.01, default: 0.66 },
        ...
        rainDistortionGlobalStrength: { type: 'slider', label: 'Global Strength', min: 0.0, max: 2.0, step: 0.01, default: 2 },
        ...
        rainStormStrengthPx: { type: 'slider', label: 'Storm Strength (px)', min: 0.0, max: 64.0, step: 0.01, default: 4.41 },
        rainStormScale: { type: 'slider', label: 'Storm Scale', min: 1.0, max: 2000.0, step: 1.0, default: 399 },
        rainStormSpeed: { type: 'slider', label: 'Storm Speed', min: 0.0, max: 10.0, step: 0.01, default: 0.25 },
        rainStormCurl: { type: 'slider', label: 'Swirl / Chaos', min: 0.0, max: 3.0, step: 0.01, default: 1.71 },
        ...
        causticsIntensity: { type: 'slider', label: 'Caustics Intensity', min: 0.0, max: 4.0, step: 0.01, default: 3.14 },
        causticsScale: { type: 'slider', label: 'Caustics Scale', min: 0.1, max: 200.0, step: 0.1, default: 33.4 },
        causticsSpeed: { type: 'slider', label: 'Caustics Speed', min: 0.0, max: 5.0, step: 0.01, default: 2.21 },
        causticsSharpness: { type: 'slider', label: 'Caustics Sharpness', min: 0.1, max: 10.0, step: 0.01, default: 0.1 },
        causticsEdgeLo: { type: 'slider', label: 'Caustics Edge Lo', min: 0.0, max: 1.0, step: 0.01, default: 0 },
        ...
        causticsBrightnessThreshold: { type: 'slider', label: 'Brightness Threshold', min: 0.0, max: 2.0, step: 0.01, default: 0.25 },
        causticsBrightnessSoftness: { type: 'slider', label: 'Brightness Softness', min: 0.0, max: 1.0, step: 0.01, default: 0.25 },
        ...
        advectionSpeed: { type: 'slider', label: 'Advection Speed', min: 0.0, max: 4.0, step: 0.01, default: 4 },
        ...
        specSunAzimuthDeg: { type: 'slider', label: 'Sun Azimuth (deg)', min: 0.0, max: 360.0, step: 1.0, default: 48 },
        specSunElevationDeg: { type: 'slider', label: 'Sun Elevation (deg)', min: 1.0, max: 90.0, step: 1.0, default: 67 },
        specSunIntensity: { type: 'slider', label: 'Sun Intensity', min: 0.0, max: 5.0, step: 0.01, default: 1.32 },
        specNormalStrength: { type: 'slider', label: 'Normal Strength', min: 0.0, max: 5.0, step: 0.01, default: 5 },
        specNormalScale: { type: 'slider', label: 'Normal Scale', min: 0.0, max: 0.25, step: 0.001, default: 0.205 },
        specRoughnessMin: { type: 'slider', label: 'Roughness Min', min: 0.001, max: 1.0, step: 0.001, default: 0.107 },
        specRoughnessMax: { type: 'slider', label: 'Roughness Max', min: 0.001, max: 1.0, step: 0.001, default: 0.841 },
        specF0: { type: 'slider', label: 'F0 (Reflectance)', min: 0.0, max: 0.12, step: 0.001, default: 0.12 },
        specMaskGamma: { type: 'slider', label: 'Mask Gamma', min: 0.1, max: 6.0, step: 0.01, default: 1.24 },
        specSkyTint: { type: 'slider', label: 'Sky Tint', min: 0.0, max: 1.0, step: 0.01, default: 1.0 },
        specShoreBias: { type: 'slider', label: 'Shore Bias', min: 0.0, max: 1.0, step: 0.01, default: 0.81 },

        specDistortionNormalStrength: { type: 'slider', label: 'Distortion→Normal', min: 0.0, max: 2.0, step: 0.01, default: 1 },
        specAnisotropy: { type: 'slider', label: 'Anisotropy', min: 0.0, max: 1.0, step: 0.01, default: 0.21 },
        specAnisoRatio: { type: 'slider', label: 'Aniso Ratio', min: 1.0, max: 8.0, step: 0.01, default: 1 },

        foamStrength: { type: 'slider', label: 'Foam Strength', min: 0, max: 1.0, step: 0.01, default: 0.2 },
        foamColor: { type: 'color', label: 'Foam Color', default: { r: 6, g: 6, b: 5 } },
        foamThreshold: { type: 'slider', label: 'Foam Width', min: 0.0, max: 1.0, step: 0.01, default: 0.83 },
        foamScale: { type: 'slider', label: 'Foam Grain Scale', min: 1.0, max: 2000.0, step: 1.0, default: 1225 },
        foamSpeed: { type: 'slider', label: 'Foam Speed', min: 0.0, max: 1.5, step: 0.01, default: 1.5 },

        foamCurlStrength: { type: 'slider', label: 'Foam Curl Strength', min: 0.0, max: 1.0, step: 0.01, default: 0.13 },
        foamCurlScale: { type: 'slider', label: 'Foam Curl Scale', min: 0.1, max: 30.0, step: 0.1, default: 11.3 },
        foamCurlSpeed: { type: 'slider', label: 'Foam Curl Speed', min: 0.0, max: 1.0, step: 0.01, default: 0.1 },

        foamBreakupStrength1: { type: 'slider', label: 'Foam Breakup 1 Strength', min: 0.0, max: 1.0, step: 0.01, default: 0.61 },
        foamBreakupScale1: { type: 'slider', label: 'Foam Breakup 1 Scale', min: 0.1, max: 200.0, step: 0.1, default: 6.5 },
        foamBreakupSpeed1: { type: 'slider', label: 'Foam Breakup 1 Speed', min: 0.0, max: 1.0, step: 0.01, default: 0.6 },
        foamBreakupStrength2: { type: 'slider', label: 'Foam Breakup 2 Strength', min: 0.0, max: 1.0, step: 0.01, default: 1 },
        foamBreakupScale2: { type: 'slider', label: 'Foam Breakup 2 Scale', min: 0.1, max: 100.0, step: 0.1, default: 14.6 },
        foamBreakupSpeed2: { type: 'slider', label: 'Foam Breakup 2 Speed', min: 0.0, max: 1.0, step: 0.01, default: 0.16 },
        ...
        foamGamma: { type: 'slider', label: 'Foam Gamma', min: 0.1, max: 4.0, step: 0.01, default: 1.39 },
        ...
        floatingFoamStrength: { type: 'slider', label: 'Floating Foam Strength', min: 0.0, max: 1.0, step: 0.01, default: 0.45 },
        floatingFoamCoverage: { type: 'slider', label: 'Floating Foam Coverage', min: 0.0, max: 1.0, step: 0.01, default: 0.2 },
        floatingFoamScale: { type: 'slider', label: 'Floating Foam Scale', min: 1, max: 200, step: 0.5, default: 47 },
        floatingFoamWaveDistortion: { type: 'slider', label: 'Wave Distortion', min: 0.0, max: 2.0, step: 0.01, default: 0.7 },
        ...
        foamPlumeMaxParticles: { type: 'slider', label: 'Plume Max Particles', min: 0, max: 20000, step: 1, default: 1681 },
        foamPlumeEmissionBase: { type: 'slider', label: 'Plume Emission Base', min: 0.0, max: 500.0, step: 0.1, default: 52.9 },
        foamPlumeEmissionWindScale: { type: 'slider', label: 'Plume Emission Wind Scale', min: 0.0, max: 1500.0, step: 0.1, default: 93.5 },
        foamPlumeLifeMin: { type: 'slider', label: 'Plume Life Min', min: 0.01, max: 10.0, step: 0.01, default: 1.5 },
        foamPlumeLifeMax: { type: 'slider', label: 'Plume Life Max', min: 0.01, max: 10.0, step: 0.01, default: 2.7 },
        ...
        foamPlumeOpacity: { type: 'slider', label: 'Plume Opacity', min: 0.0, max: 2.0, step: 0.01, default: 0.23 },
        ...
        foamPlumeAdditiveBoost: { type: 'slider', label: 'Plume Additive Boost', min: 0.0, max: 20.0, step: 0.01, default: 1.51 },
        foamPlumeColor: { type: 'color', label: 'Plume Color', default: { r: 1.0, g: 1.0, b: 1.0 } },

        foamPlumeRandomOpacityMin: { type: 'slider', label: 'Plume Random Opacity Min', min: 0.0, max: 5.0, step: 0.01, default: 1.03 },
        foamPlumeRandomOpacityMax: { type: 'slider', label: 'Plume Random Opacity Max', min: 0.0, max: 5.0, step: 0.01, default: 5 },
        ...
        foamPlumeRadialMidOpacity: { type: 'slider', label: 'Plume Radial Mid Opacity', min: 0.0, max: 5.0, step: 0.01, default: 0.58 },
        foamPlumeRadialOuterOpacity: { type: 'slider', label: 'Plume Radial Outer Opacity', min: 0.0, max: 5.0, step: 0.01, default: 0.31 },
        ...
        foamParticleNoiseStrength: { type: 'slider', label: 'Cutout Noise (Large) Strength', min: 0.0, max: 1.0, step: 0.01, default: 1 },
        foamParticleNoiseScale: { type: 'slider', label: 'Cutout Noise (Large) Scale', min: 0.1, max: 120.0, step: 0.1, default: 22.2 },
        ...
        simpleFoamThreshold: { type: 'slider', label: 'Spawn Threshold', min: 0.01, max: 1.0, step: 0.01, default: 0.79 },
        simpleFoamStride: { type: 'slider', label: 'Scan Stride', min: 1, max: 32, step: 1, default: 2 },
        simpleFoamMaxPoints: { type: 'number', label: 'Max Points', min: 10, max: 50000, step: 10, default: 23560 },
        ...
        sandIntensity: { type: 'slider', label: 'Sand Intensity', min: 0.0, max: 1.0, step: 0.01, default: 1 },
        sandColor: { type: 'color', label: 'Sand Color', default: { r: 51, g: 45.852033635195596, b: 10.960533142089842 } },
        sandContrast: { type: 'slider', label: 'Sand Contrast', min: 0.25, max: 4.0, step: 0.01, default: 0.25 },
        sandChunkScale: { type: 'slider', label: 'Sand Chunk Scale', min: 0.1, max: 20.0, step: 0.1, default: 16.6 },
        sandChunkSpeed: { type: 'slider', label: 'Sand Chunk Speed', min: 0.0, max: 3.0, step: 0.01, default: 3 },
        sandGrainScale: { type: 'slider', label: 'Sand Grain Scale', min: 10.0, max: 400.0, step: 1.0, default: 54 },
        sandGrainSpeed: { type: 'slider', label: 'Sand Grain Speed', min: 0.0, max: 5.0, step: 0.01, default: 5 },
        sandBillowStrength: { type: 'slider', label: 'Sand Billow Strength', min: 0.0, max: 1.0, step: 0.01, default: 1 },

        sandCoverage: { type: 'slider', label: 'Sand Coverage', min: 0.0, max: 1.0, step: 0.01, default: 1 },
        sandChunkSoftness: { type: 'slider', label: 'Sand Chunk Softness', min: 0.01, max: 0.5, step: 0.01, default: 0.5 },
        sandSpeckCoverage: { type: 'slider', label: 'Sand Speck Coverage', min: 0.0, max: 1.0, step: 0.01, default: 0.51 },
        sandSpeckSoftness: { type: 'slider', label: 'Sand Speck Softness', min: 0.01, max: 0.5, step: 0.01, default: 0.5 },
        ...
        sandDistortionStrength: { type: 'slider', label: 'Sand Distortion Strength', min: 0.0, max: 1.0, step: 0.01, default: 0.37 },
      ...
      if (dm && typeof dm.getSource === 'function' && typeof dm.registerSource === 'function') {
        ...
        if (src) {
          ...
          if (typeof dm.updateSourceParams === 'function') {
            ...
            p.causticsBrightnessThreshold = Number.isFinite(this.params?.causticsBrightnessThreshold) ? this.params.causticsBrightnessThreshold : 0.25;
