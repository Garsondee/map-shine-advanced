 ...
 * @property {string} category   - gameplay | lighting | atmospheric | surface | particle | post
...
const CAPABILITIES = [
  ...
  { effectId: 'filter',            displayName: 'Ink & Line AO',             category: 'surface',      performanceImpact: 'low' },
  { effectId: 'window-lights',     displayName: 'Window Lights',             category: 'lighting',     performanceImpact: 'medium' },
  { effectId: 'water',             displayName: 'Water',                     category: 'surface',      performanceImpact: 'high' },
  { effectId: 'bloom',             displayName: 'Bloom Highlights',          category: 'lighting',     performanceImpact: 'high' },
  { effectId: 'color-correction',  displayName: 'Color Correction',          category: 'post',         performanceImpact: 'low' },
  { effectId: 'dot-screen',        displayName: 'Dot Screen',                category: 'post',         performanceImpact: 'low' },
  ...
  { effectId: 'overhead-shadows',  displayName: 'Overhead Shadows',          category: 'lighting',     performanceImpact: 'medium' },
  { effectId: 'building-shadows',  displayName: 'Building Shadows',          category: 'lighting',     performanceImpact: 'medium' },
  { effectId: 'painted-shadows',   displayName: 'Painted Shadows',           category: 'lighting',     performanceImpact: 'medium' },
  ...
  { effectId: 'ascii',             displayName: 'ASCII',                     category: 'post',         performanceImpact: 'high' },
  { effectId: 'halftone',          displayName: 'Halftone',                  category: 'post',         performanceImpact: 'medium' },
  { effectId: 'sharpen',           displayName: 'Sharpen',                   category: 'post',         performanceImpact: 'low' },
  { effectId: 'sky-color',         displayName: 'Sky Environment',           category: 'lighting',     performanceImpact: 'low' },
  { effectId: 'window-light',      displayName: 'Window Lights',             category: 'lighting',     performanceImpact: 'low' },
  ...
  { effectId: 'lighting',          displayName: 'Lighting',                  category: 'lighting',     performanceImpact: 'high' },
  { effectId: 'visionMode',        displayName: 'Vision Mode',               category: 'gameplay',     performanceImpact: 'low' },
  { effectId: 'fog',               displayName: 'Fog of War',                category: 'gameplay',     performanceImpact: 'low' },
