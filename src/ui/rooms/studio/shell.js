 ...
 * departments whose own stage hasn't landed yet (PAINTER=U4, CUES=U3,
 * SYSTEM=U5); clicking one of those shows an honest "lands in a later
 * stage" placeholder rather than either hiding the tab (Law 9's set is
 * fixed from day one) or faking content that doesn't exist yet.
...
const DEPTS = Object.freeze([
  ...
  { id: 'cues', label: 'Cues', icon: 'clap', accVar: '--c-post', render: null, stage: 'U3' },
